...
for patID in FVLData_unpro:
    ...
    # Create a spiro signal process object (new API requires a scale2 argument for time)
    # scale2: factor to multiply 'time' input (e.g., 1 if time is already in seconds)
