...
* `scale3`: Numeric factor to scale the time array (e.g., convert milliseconds to seconds or apply custom unit scaling)
...
sp = spiro_signal_process(
    ...
    scale3=1.0  # apply no scaling; adjust as needed to convert time units
)
