...
* `scale2`: Scale factor applied to the input time array (e.g., 1 for seconds, 1000 for milliseconds)

> Note: `scale2` is used internally to convert provided `time` units into seconds.
