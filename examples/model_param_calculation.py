...
for EMD in Best_FVL:
    ...
    age = 60 # years
    height = 175 # cm
    race = 'Caucasian'  # demographic identifier for predicted area calculation
    ...
    # Note: The 'excitation_type' parameter is now primarily for internal tracking;
    # only the default PEF-based initial condition is actively modeled.
